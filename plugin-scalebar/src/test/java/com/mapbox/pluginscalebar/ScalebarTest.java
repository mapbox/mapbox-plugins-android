...
public class ScalebarTest {
  ...
  public void setUp() {
    ...
    when(resources.getColor(0xff000000)).thenReturn(0xff000000);
    when(resources.getColor(0xff000001)).thenReturn(0xff000001);
    when(resources.getColor(0xff000002)).thenReturn(0xff000002);
